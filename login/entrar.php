        ...
        <section class="container mx-auto my-10 p-6">
            <div class="max-w-lg mx-auto bg-white p-8 rounded shadow">
                ...
                <div class="flex justify-center mb-6 mt-4">
                    ...
                    <a href="/Projeto/Cliente/cadastro/cadastrocliente.php" class="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 mx-1">Cadastro cliente</a>
                    <a href="/Projeto/nutricionista/cadastro/cadastronutri.php" class="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 mx-1">Cadastro nutricionista</a>
                    <a href="/Projeto/Senha/Alterarsenha.php" class="px-4 py-2 bg-red-500 text-white rounded hover:bg-red-900 mx-1">Alterar Senha</a>
                </div>
