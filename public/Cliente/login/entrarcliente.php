    ...
    <header class="fixed top-0 w-full z-10 bg-white shadow-md p-4">
        <nav class="container mx-auto flex justify-between items-center">
            ...
            <div>
                ...
                <a href="Cliente/cadastro/cadastrocliente.php" class="bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600">Cadastre-se</a>
            </div>
        </nav>
    </header>
    <div class="h-16"></div>
        ...
        <section class="container mx-auto my-10 p-6">
            <div class="max-w-lg mx-auto bg-white p-8 rounded shadow">
                ...
                <div id="loginForm">
                    ...
                    <form action="/Cliente/login/logincliente.php"  method="POST" id="submit">
<input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars($csrf, ENT_QUOTES); ?>">
                ...
                <div class="flex justify-center mb-6 mt-4">
                    ...
                    <a href="Cliente/cadastro/cadastrocliente.php" class="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 mx-1">Cadastre-se</a>
                    <a href="Cliente/login/senhacliente.php" class="px-4 py-2 bg-red-500 text-white rounded hover:bg-red-900 mx-1">Alterar Senha</a>
                </div>
