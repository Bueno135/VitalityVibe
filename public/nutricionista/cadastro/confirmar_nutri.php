...
<head>
    ...
    <link href="cadastro/confirmarcadastro.css" rel="stylesheet">
    ...
    <script>
        function confirmarUser() {
            window.location.href="login/entrarnutri.php";
        }
        function editarUser(){
    ...
    <header>
        <nav class="container mx-auto flex justify-between items-center">
            ...
            <div>
                ...
                <a href="cadastro/entrarnutri.php" class="mx-2 hover:text-blue-500">Login</a>
                <a href="cadastro/cadastronutri.php" class="bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600">Cadastre-se</a>
            </div>
        </nav>
    </header>
