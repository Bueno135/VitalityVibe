    ...
    <header class="fixed top-0 w-full z-10 bg-white shadow-md p-4">
        <nav class="container mx-auto flex justify-between items-center">
            ...
            <div>
                ...
                <a href="nutricionista/cadastro/cadastronutri.php" class="bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600">Cadastre-se</a>
            </div>
        </nav>
    </header>
    <div class="h-16"></div>
...
<input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars($csrf, ENT_QUOTES); ?>">
                        ...
                        <div class="text-center">
                            <button type="submit" onclick="verificarLogin()" class="w-full inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700">Entrar</button>
                        </div>
                ...
                <div class="flex justify-center mb-6 mt-4">
                    ...
                    <a href="nutricionista/cadastro/cadastronutri.php" class="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 mx-1">Cadastre-se</a>
                    <a href="nutricionista/login/senhanutri.php" class="px-4 py-2 bg-red-500 text-white rounded hover:bg-red-900 mx-1">Alterar Senha</a>
                </div>
        ...
        <div class="container mx-auto p-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div>
                ...
                <ul>
                    ...
                    <li><a href="cadastro/cadastronutri.php" class="hover:text-blue-400">Cadastre-se</a></li>
                </ul>
            </div>
