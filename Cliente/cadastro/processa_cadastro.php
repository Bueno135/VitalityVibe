...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(mysqli_num_rows($retorno) > 0) {
        ...
        $sql3 = "INSERT INTO cliente (nome, email, senha, cpf, dt_nasc, sexo, cep, telefone,  problema_saude, freq_atv_fisica, alergias, peso, altura, objetivo,med_controlado) 
        VALUES ('$nome', '$email', '$senha', '$cpf', '$dt_nasc', '$sexo', '$cep',  '$problema_saude', '$freq_atv_fisica', '$telefone', '$alergias', '$peso','$altura', '$objetivo','$med_controlado')";
