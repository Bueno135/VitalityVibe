...
<body class="bg-gray-100 flex flex-col min-h-screen">
                ...
                <div id="cadastroForm">
                    ...
                    <form id="form-cadastro" method="POST" action="processa_cadastro.php">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="password" id="confirmarSenha" name="confirmarSenha" class="bg-gray-50 mt-1 block w-full rounded-md border border-gray-300 shadow-md" required>
                        </div>
                        <div class="mb-6">
                            <label for="cpf" class="block text-sm font-medium text-gray-700">CPF</label>
                            <input id="cpf" name="cpf" inputmode="numeric" maxlength="14" class="bg-gray-50 mt-1 block w-full rounded-md border border-gray-300 shadow-md" required>
                        </div>
                        <div class="mb-6">
                            <label for="telefone" class="block text-sm font-medium text-gray-700">Telefone</label>
                            <input inputmode="numeric" id="telefone" name="telefone" maxlength="15" class="bg-gray-50 mt-1 block w-full rounded-md border border-gray-300 shadow-md" required>
                        </div>
                        <div class="mb-6">
                        ...
                        <div class="mb-6">
                            ...
                            <input id="cep" name="cep" inputmode="numeric" pattern="[0-9]{5}-[0-9]{3}" maxlength="9" placeholder="_____-___" class="bg-gray-50 mt-1 block w-full rounded-md border border-gray-300 shadow-md" required>
                        </div> 
                        <div class="mb-6">
                        ...
                        <div class="mb-6">
                            <label for="peso" class="block text-sm font-medium text-gray-700">Qual o seu peso? (Em Quilogramas/Kg)</label>
                            <input type="text" id="Peso" name="peso" inputmode="numeric" pattern="[0-9]*" maxlength="5" class="bg-gray-50 mt-1 block w-full rounded-md border border-gray-300 shadow-md" required>
                        </div>
                        <div class="mb-6">
    ...
    <script>
        ...
        document.getElementById('form-cadastro').addEventListener('submit', function(event) {
            if (!verificarIdade() || !verificarSenha()) {
